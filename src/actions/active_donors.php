...
$query = "SELECT campaign_name, name, IFNULL(sum, altsum) AS amount, date FROM overalldonate ORDER BY date DESC LIMIT :limit OFFSET :offset";
...
$totalQuery = "SELECT COUNT(*) as total FROM overalldonate";
